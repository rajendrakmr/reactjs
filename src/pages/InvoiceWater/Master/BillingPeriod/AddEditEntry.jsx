    ...
    >
      <div className="modal-body _rkContent" style={{ flex: "unset", minHeight: "10vh" }}>
        ...
        <div className="row py-2 pb-5 _rkContentBorder">
          <InputFormField label="Billing Period" name="billPeriodName" inputData={formData} hasError={hasError} errorMsg={errors} onChange={memoizedHandleChange} isRequired={true} />
          {
            isEdit && (
              <SelectFormInput
