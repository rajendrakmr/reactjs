    ...
    >
      <div className="modal-body _rkContent" style={{ flex: "unset", minHeight: "10vh" }}>
        ...
        <div className="row py-2 pb-5 _rkContentBorder">
          ...
          <InputFormField label="Consumer Type Desc" col="col-md-5" name="consumerTypeDesc" inputData={formData} hasError={hasError} errorMsg={errors} onChange={memoizedHandleChange} isRequired={true}  />
