              ...
              {sisRequisitionChildList.length > 0 && sisRequisitionChildList?.map((row, parentIndex) => (
                <React.Fragment key={parentIndex}>
                  <tr>
                    ...
                    <InputCellField value={row.chargableHead} onChange={(e) => handleChange(e, parentIndex, 'chargableHead')} name="chargableHead" errorMsg={setError(parentIndex, 'chargableHead')} className="wide-input3" />
