...
import { GetReportDepoCode, GetReportType } from "../apiService"; 
    ...
    return (
        <section >
            <div className="container mt-5">
                <BreadCrumb item={{ label: 'Store', 'sub_label': 'Report', active: true, current: 'Job Code Wise Item Register' }} />
                <div className="pb-4">
                    <div className="align-items-center primary-light-bg text-white p-1 text-bold text-center position-relative">
                        <h5>Job Code Wise Item Register</h5>
                    </div>
                    <MandatoryField />
                    {serError && (
