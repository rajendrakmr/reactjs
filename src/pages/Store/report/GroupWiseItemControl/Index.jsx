...
import { GetReportDepoCode, GetReportGroupCode, GetReportType } from "../apiService";
...
const GroupWiseItemControl = () => {
    ...
    const [reportGroupOptions, setReportGroupOptions] = useState([{ value: "0", label: "All" }]);
    ...
    useEffect(() => { 
        GetReportDepoCode(dispatch, setReportDepoOptions, 'null')
        GetReportGroupCode(dispatch, setReportGroupOptions, 'null')
    }, []);
    ...
    const handleChangeSelect = useCallback((e, field) => {
        ...
        setFormData((prevFormData) => ({
            ...prevFormData,
            [field]: value,
            ...(field === "depoCode" && { groupCode: null, fromDate:null, toDate:null }),
            ...(field === "groupCode" && {fromDate:null, toDate:null })
        })); 
        setErrors(prevErrors => {
            const updatedErrors = { ...prevErrors };
    ...
    return (
        <section >
            <div className="container mt-5">
                <BreadCrumb item={{ label: 'Store', 'sub_label': 'Report', active: true, current: 'Group Wise Item Control' }} />
                <div className="pb-4">
                    ...
                    <div className="_rkContentBorder row py-2">
                        <div className="row mx-auto mw-100">
                            ...
                            <SelectFormInput
                                onChange={(selectedOption) => handleChangeSelect(selectedOption, 'groupCode')}
                                error={setSelectError('groupCode')}
                                id="groupCode"
                                name="groupCode"
