  ...
  return (
    ...
    >
      <div className="modal-body _rkContent" style={{ flex: "unset", minHeight: "10vh" }}>
        ...
        <div className="row py-2 pb-5 _rkContentBorder" style={{ alignItems: "center" }}>
          <InputFormField label="Unit Code" name="unitCode" inputData={formData} hasError={hasError} errorMsg={errors} onChange={memoizedHandleChange} isRequired={true} type="number" max="5" />

          <InputFormField label="Unit Description" name="unitDescription" inputData={formData} hasError={hasError} errorMsg={errors} onChange={memoizedHandleChange} isRequired={true} />
          {
            isEdit && (
              <SelectFormInput
