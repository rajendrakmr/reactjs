    ...
    >
      <div className="modal-body _rkContent" style={{ flex: "unset", minHeight: "10vh" }}>
        ...
        <div className="row py-2 pb-5 _rkContentBorder">
          ...
          <InputFormField label="Depot Code" name="depoCode" inputData={formData} hasError={hasError} errorMsg={errors} onChange={memoizedHandleChange} isRequired={true} max="5" type="number" />
          <InputFormField label="Depot Description" name="depoDescription" inputData={formData} hasError={hasError} errorMsg={errors} onChange={memoizedHandleChange} isRequired={true} />


          <SelectFormInput
            onChange={(selectedOption) => handleChangeSelect(selectedOption, 'moduleFlag')}
            error={setSelectError('moduleFlag')}
            id="moduleFlag"
            name="moduleFlag"
            value={formData.moduleFlag}
            options={flagOptions}
            label="Module Flag"
            required={true}
          />
