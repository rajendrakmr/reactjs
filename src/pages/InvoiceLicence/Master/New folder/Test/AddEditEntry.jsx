    ...
    >
      <div className="modal-body _rkContent" style={{ flex: "unset", minHeight: "10vh" }}>
        ...
        <div className="row py-2 pb-5 _rkContentBorder"> 
          <InputFormField label="Connection Type Desc" name="connectionTypeDesc" inputData={formData} hasError={hasError} errorMsg={errors} onChange={memoizedHandleChange} isRequired={true} col="col-md-5"  />
          <InputFormField label="Connection Type Desc" name="connectionTypeCode" inputData={formData} hasError={hasError} errorMsg={errors} onChange={memoizedHandleChange} isRequired={true} col="col-md-5"  />
