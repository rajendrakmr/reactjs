...
const SearchInputDateField = ({
    ...
    const [startDate, setStartDate] = useState(inputData ? parseDateString(inputData) : null);


    useEffect(() => {
        setStartDate(inputData ? parseDateString(inputData) : null);
    }, [inputData]);
...
export default SearchInputDateField;
